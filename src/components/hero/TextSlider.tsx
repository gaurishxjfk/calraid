    ...
    return (
      <div
        className="md:shadow-md w-[100%] sm:w-[75%] lg:w-[65%] asm:mx-auto -mt-8 md:mt-0 !md:mr-aut6o md:absolute left-0 
                ...
                "
      >
        <div className=" text-[#1f1f1f] w-[100%] sm:w-[70%] umd:w-[65%] md:ml-[14%] p-2 flex flex-col gap-1">
          ...
          <p className="line-clamp-2s playwrite-us-trad- italic">
            {currentText.desc}
          </p>
          <Link to={currentText.link} className="underline">
            Read More...
          </Link>
        </div>
      </div>
